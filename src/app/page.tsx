  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <header className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <StepSafeLogo className="h-8 w-auto text-primary" />
      </header>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 max-w-2xl mx-auto text-base md:text-lg text-foreground/80">
              Personalized outdoor safety guidance based on real-time weather and air quality. Make every step outside a safer one.
            </p>
            <div className="mt-10">
